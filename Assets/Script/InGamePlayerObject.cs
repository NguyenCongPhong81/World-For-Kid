...
namespace Script
{
    public class InGamePlayerObject : MonoBehaviour
    {
        ...
        public static InGamePlayerObject LastSelected;
        ...
        public void Init(PlayerInGameData ownerData)
        {
            ...
            {
                if (ownerData.UserName.Equals(InGameManager.Instance.myPlayer.UserName))
                {
                    mine.SetActive(true);
                }
            }
        ...
        public void ChangeHeath(int delta)
        {
            ...
            if (_playerInGameData.Heath <= 0)
            {
                ...
                InGameManager.Instance.ui.CheckResult();
            }
        }
